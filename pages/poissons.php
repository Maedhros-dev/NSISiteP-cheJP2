<!-- Il existe plusieurs espèces de poissons tout d'abord les poissons d'eau de mer présent sur les litoraux francais ainsi que les poissons d'eau douce présent dans les eaux intérieurs comme les étangs,les canaux, les lacs, les rivieres
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <div id="c1">
                    <div class="tt">
                      <p>Tout d'abord, il existe plusieurs espèces de poissons on distinguent les poissons d'eau de mer présent sur les litoraux francais des poissons d'eau douce présent dans les eaux intérieures comme les étangs,les canaux, les lacs et les rivieres.
                      </p>
                        <h2>En Mer</h2>
                        
                            <p>En manche on peut trouver des poissons de roches comme le bar, le lieu jaune au niveau des épaves, des rougets, 
                                des chinchard en passant par le mulet. Les crustacés comme les tourteaux, les etrilles, les homards. 
                                Les crevettes (bouquets et grises) occupent aussi une place importante pour
                                les pêcheurs aux havenaux notamment sur les plages de Normandie. Les bars en Bretagne sont plus noirs 
                                que sur le littoral Atlantique il se cammouflent grâce aux rochers noirs.Un exemple de réserve halieutique très 
                                importante est le poisson sans doute le plus connu et peché en Manche le maquereau.</p>
                        </ul>
                    </div>
                </div>
                <div class="cartes">
                ...
                <div id="c2">
                    <div class="tt">
                        <h2>En Rivière</h2>
                        <ul>
                            <li>L'eau douce abritent de nombreux poissons dans divers milieux comme les canaux, les lacs, les rivieres de 1ere et 2eme catégorie, les étang.</li>
                            <li>Les carnassiers sont des poissons qui mangent d'autres poissons dit blanc souvent des gardons ou des ablettes mais peuvent se mangers
                                entre memes especes (Brochet,perche, black-bass, silure, sandre, perche soleil).Les carpes sont des categories</li>
                        </ul>
                    </div>
                </div>
                <div class="cartes">
